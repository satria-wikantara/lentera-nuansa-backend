...
namespace nuansa::messages {
    ...
    struct MessageHeader {
        ...
        std::string contentType;        // Format of the payload (e.g., "application/json")
        ...
        static MessageHeader FromJson(const nlohmann::json& json) {
            return MessageHeader{
                ...
                json["messageId"].get<std::string>(),
                json["timestamp"].get<time_t>(),
                json["messageType"].get<std::string>(),
                json["correlationId"].get<std::string>(),
                json["priority"].get<int>(),
                json["contentType"].get<std::string>(),
                json["encoding"].get<std::string>(),
                json["messageLength"].get<size_t>(),
                json["messageHash"].get<std::string>(),
                json["customHeaders"].get<std::map<std::string, std::string>>()
            };
        }
