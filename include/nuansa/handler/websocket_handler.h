...
public:
    ...
    void SendAckMessage(std::shared_ptr<WebSocketClient> client,
                       const std::string& messageId,
                       bool success,
                       const std::string& details = "");
    void SendTypingNotification(const std::string& username,
                               bool isTyping,
    ...
    void SendErrorMessage(std::shared_ptr<WebSocketClient> client,
